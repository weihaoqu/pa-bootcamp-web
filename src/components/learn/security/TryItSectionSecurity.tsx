...
interface TryItSectionSecurityProps {
  moduleSlug: string;
}

export default function TryItSectionSecurity({ moduleSlug }: TryItSectionSecurityProps) {
  return (
    <section id="try-it" className="scroll-mt-20">
      <h2 className="mb-4 text-2xl font-bold text-navy">Ready to Build Your Own?</h2>
      <p className="mb-6 text-slate-600">
        You now understand taint lattices, propagation rules, security configurations (sources/sinks/sanitizers),
        and the difference between explicit and implicit information flow. Time to implement a taint analyzer in OCaml.
      </p>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-emerald-900">Security Analysis Explorer</h3>
        ...
        <Link
          href={`/modules/${moduleSlug}/exercises/taint-lattice`}
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-navy">Exercise 1: Taint Lattice</h3>
